var Zepto = function () {
    ...
    X.fragment = function (t, e, n) {
        var r,
            i,
            a;
        return _.test(t) && (r = j(P.createElement(RegExp.$1))),
        r || (
            t.replace && (t = t.replace(D, "<$1></$2>")),
            e === w && (e = Z.test(t) && RegExp.$1),
            e in I || (e = "*"),
            a = I[e],
            a.innerHTML = "" + t,
    ...
    X.init = function (t, n) {
        ...
        if (!t) 
            return X.Z();
        if ("string" == typeof t) 
            if (t = t.trim(), "<" == t[0] && Z.test(t)) 
                r = X.fragment(t, RegExp.$1, n),
                t = null;
            else {
                if (n !== w) 
                    return j(n).find(t);
            ...
            if (Y(t)) 
                ...
                r = X.fragment(t.trim(), RegExp.$1, n),
                t = null;
            else {
                if (n !== w) 
                    return j(n).find(t);
    ...
    j.contains = P.documentElement.contains
        ? function (t, e) {
    ...
    j.fn = {
        ...
        ready: function (t) {
            return J.test(P.readyState) && P.body
                ? t(j)
        ...
        val: function (t) {
            return 0 in arguments
                ...
                : this[0] && (
                    this[0].multiple
                        ? j(this[0]).find("option").filter(function () {
        ...
        offsetParent: function () {
            return this.map(function () {
                for (
                    ...
                    t && !$.test(t.nodeName) && "static" == j(t).css("position");
                ) 
                    t = t.offsetParent;
                return t
            })
...
function (t) {
    ...
    function n(t, n, o, a) {
        ...
        return (v[e(t)] || []).filter(function (t) {
            return !(
                !t || n.e && t.e != n.e || n.ns && !s.test(t.ns) || o && e(t.fn) !== e(o) || a && t.sel != a
            )
        })
    }
    function r(t) {
    ...
    (
        "focusin focusout focus blur load resize scroll unload click dblclick mousedown" +
        " mouseup mousemove mouseover mouseout mouseenter mouseleave change select keyd" +
        "own keypress keyup error"
    )
        .split(" ")
        .forEach(function (e) {
            t.fn[e] = function (t) {
...
function (t) {
    ...
    function o(t, e) {
        ...
        return e
            .beforeSend
            .call(r, t, e) !== !1 && n(e, r, "ajaxBeforeSend", [t, e]) !== !1 && void n(
                e,
                r,
                "ajaxSend",
                [t, e]
    ...
    t.ajax = function (e) {
        ...
        i.crossDomain || (
            ...
            n.href = i.url,
            n.href = n.href,
            i.crossDomain = S.protocol + "//" + S.host != n.protocol + "//" + n.host
        ),
        ...
        if (
            d && (p = "jsonp"),
            i.cache !== !1 && (e && e.cache === !0 || "script" != p && "jsonp" != p) || (i.url = f(i.url, "_=" + Date.now())),
            "jsonp" == p
        ) 
            return d || (i.url = f(
                i.url,
        ...
        if (
            ...
            (x = i.mimeType || x) && (
                ...
                j.overrideMimeType && j.overrideMimeType(x)
            ),
...
function (t) {
    t.fn.serializeArray = function () {
        ...
        return this[0] && t.each(this[0].elements, function (r, o) {
            ...
            e && "fieldset" != o
                .nodeName
                .toLowerCase() && !o.disabled && "submit" != n && "reset" != n && "button" != n && "file" != n && (
        ...
        function r(e) {
            ...
            return t.each(c, function (t, r) {
                for (var t = 0; t < s.length; t++) 
                    void 0 !== r[s[t]] && r[s[t]]
                        .toLowerCase()
                        .indexOf(e.toLowerCase()) !== -1 && (n.push(r), t = s.length)
                }),
            n
        }
        function i(e) {
        ...
        var a = t.extend(
                {
                    ...
                    template: '<li><article><a href="{url}">{title} <span class="entry-date"><time datetime="' +
                            '{date}">{date}</time></span></a></article></li>',
...
function (t, e, n) {
    ...
    t("#searching").click(function () {
        ...
        t("#search").trigger("click")
    }),
    t(document).keydown(function (e) {
        if (!t(".search-form").hasClass("active")) 
            switch (e.key) {
                case " ":
        ...
        t("#sidebar").hasClass("slide") && (
            "s" === e.key
                ? (t("#fade").trigger("click"), t("#search").trigger("click"))
                : t("#sidebar ul").find("[key-trigger='" + e.key + "']").trigger("click")
        ),
        t(".search-form").hasClass("active") && "Escape" === e.key && t(
            ".icon-remove-sign"
        ).trigger("click")
    }),
    t(document).keyup(function (e) {
        t(".search-form").hasClass("active")
            ? t(".search-form")
                .find("input")
                .focus()
            : t(".search-form")
